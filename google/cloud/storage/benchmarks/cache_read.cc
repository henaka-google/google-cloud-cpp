...
using gcs_bm::CacheReadTestOptions;
...
google::cloud::StatusOr<CacheReadTestOptions> ParseArgs(
    int argc, char* argv[]);
...
void PrintResults(CacheReadTestOptions const& options,
...
int main(int argc, char* argv[]) {
  ...
  auto configs = [](CacheReadTestOptions const& options,
...
google::cloud::StatusOr<CacheReadTestOptions> SelfTest(
    char const* argv0) {
  ...
  return gcs_bm::ParseCacheReadTestOptions(
      {
          argv0,
...
google::cloud::StatusOr<CacheReadTestOptions> ParseArgs(
  ...
  auto options = gcs_bm::ParseCacheReadTestOptions(
